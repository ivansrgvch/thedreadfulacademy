...
screen main_menu():
    ...
    imagemap:
        ...
        idle 'gui/gamemenu2.png'
        hover "gui/gamemenu1.png"
        

        hotspot (150, 90, 430, 80) action Start()
        hotspot (150, 273, 350, 70) action ShowMenu("load")
        hotspot (150, 450, 380, 65) action ShowMenu("preferences")
        hotspot (147, 630, 280, 79) action ShowMenu("about")
        hotspot (1575, 986, 310, 79) action ShowMenu("help")
        hotspot (150, 990, 232, 75) action Quit(confirm=True)
